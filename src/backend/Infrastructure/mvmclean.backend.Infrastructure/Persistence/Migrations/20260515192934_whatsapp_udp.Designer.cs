...
namespace mvmclean.backend.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260515192934_whatsapp_udp")]
    partial class whatsapp_udp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mvmclean.backend.Domain.Aggregates.WhatsAppChat.WhatsAppChat", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("WhatsAppChats", (string)null);
                });
                    ...
                    b.OwnsMany("mvmclean.backend.Domain.Aggregates.Booking.ValueObjects.BookingItem", "ServiceItems", b1 =>
                        {
                            ...
                            b1.OwnsOne("mvmclean.backend.Domain.SharedKernel.ValueObjects.Money", "OriginalPrice", b2 =>
                                {
            ...
            modelBuilder.Entity("mvmclean.backend.Domain.Aggregates.WhatsAppChat.WhatsAppChat", b =>
                {
                    b.OwnsMany("mvmclean.backend.Domain.Aggregates.WhatsAppChat.ValueObjects.ChatMessage", "Messages", b1 =>
                        {
                            b1.Property<Guid>("WhatsAppChatId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("WhatsAppChatId", "Id");

                            b1.ToTable("ChatMessage");

                            b1.WithOwner()
                                .HasForeignKey("WhatsAppChatId");
                        });
                    ...
                    b.OwnsOne("mvmclean.backend.Domain.SharedKernel.ValueObjects.PhoneNumber", "PhoneNumber", b1 =>
                        {
                            ...
                            b1.HasKey("WhatsAppChatId");

                            b1.ToTable("WhatsAppChats");
